        ...
        (function (a) {
            function e(b, c) {
                ...
                if (this.sliderElem) p = !0;
                    ...
                    if (
                        (w && this.options.labelledby[0] && m.setAttribute("aria-labelledby", this.options.labelledby[0]),
                        w && this.options.labelledby[1] && n.setAttribute("aria-labelledby", this.options.labelledby[1]),
                        !w && this.options.labelledby && (m.setAttribute("aria-labelledby", this.options.labelledby), n.setAttribute("aria-labelledby", this.options.labelledby)),
                        (this.ticks = []),
                ...
                if ((this.sliderElem.addEventListener("mousedown", this.mousedown, !1), (this.resize = this._resize.bind(this)), window.addEventListener("resize", this.resize, !1), "hide" === this.options.tooltip))
                    ...
                    if (((this.showTooltip = this._showTooltip.bind(this)), (this.hideTooltip = this._hideTooltip.bind(this)), this.options.ticks_tooltip)) {
                        ...
                        (this.handleCallbackMap.handle1 = { mouseEnter: P, mouseLeave: Q }),
                            ...
                            (this.handleCallbackMap.handle2 = { mouseEnter: P, mouseLeave: Q });
                    ...
                    logarithmic: {
                        toValue: function (a) {
                            ...
                            return Math.round(d) === this.options.max
                                ? this.options.max
                                : ((d = this.options.min + Math.round((d - this.options.min) / this.options.step) * this.options.step), d < this.options.min ? this.options.min : d > this.options.max ? this.options.max : d);
                        },
                        toPercentage: function (a) {
                            if (this.options.max === this.options.min) return 0;
            ...
            if (
                    ...
                    _layout: function () {
                        ...
                        if (
                            ...
                            for (var b = 0; b < this.options.rangeHighlights.length; b++) {
                                ...
                                f
                                    ? "vertical" === this.options.orientation
                                        ? ((this.rangeHighlightElements[b].style.top = f.start + "%"), (this.rangeHighlightElements[b].style.height = f.size + "%"))
                                        : (this.options.rtl ? (this.rangeHighlightElements[b].style.right = f.start + "%") : (this.rangeHighlightElements[b].style.left = f.start + "%"),
                        ...
                        if (Array.isArray(this.options.ticks) && this.options.ticks.length > 0) {
                            ...
                            if (this.tickLabelContainer) {
                                ...
                                else for (k = 0; k < this.tickLabelContainer.childNodes.length; k++) this.tickLabelContainer.childNodes[k].offsetHeight > j && (j = this.tickLabelContainer.childNodes[k].offsetHeight);
                            ...
                            for (var k = 0; k < this.options.ticks.length; k++) {
                                ...
                                this.options.reversed && (l = 100 - l),
                                    ...
                                    this.options.range
                                        ? l >= a[0] && l <= a[1] && this._addClass(this.ticks[k], "in-selection")
                                        : "after" === this.options.selection && l >= a[0]
                                        ? this._addClass(this.ticks[k], "in-selection")
                                        : "before" === this.options.selection && l <= a[0] && this._addClass(this.ticks[k], "in-selection"),
                                    this.tickLabels[k] &&
                                        ((this.tickLabels[k].style[h] = i + "px"),
                                        "vertical" !== this.options.orientation && void 0 !== this.options.ticks_positions[k]
                                            ? ((this.tickLabels[k].style.position = "absolute"), (this.tickLabels[k].style[this.stylePos] = l + "%"), (this.tickLabels[k].style[g] = -i / 2 + "px"))
                                            : "vertical" === this.options.orientation &&
                                              (this.options.rtl ? (this.tickLabels[k].style.marginRight = this.sliderElem.offsetWidth + "px") : (this.tickLabels[k].style.marginLeft = this.sliderElem.offsetWidth + "px"),
                    ...
                    _adjustPercentageForRangeSliders: function (a) {
                        if (this.options.range) {
                            ...
                            0 === this._state.dragged && this._applyToFixedAndParseFloat(this._state.percentage[1], b) < c
                                ...
                                : 0 === this._state.keyCtrl && (this._state.value[1] / this.options.max) * 100 < a
                                ? ((this._state.percentage[0] = this._state.percentage[1]), (this._state.keyCtrl = 1), this.handle2.focus())
                                : 1 === this._state.keyCtrl && (this._state.value[0] / this.options.max) * 100 > a && ((this._state.percentage[1] = this._state.percentage[0]), (this._state.keyCtrl = 0), this.handle1.focus());
                        }
                    },
                    _mouseup: function () {
                        if (!this._state.enabled) return !1;
                ...
                var h = void 0;
                a.fn.slider ? (windowIsDefined && window.console.warn("bootstrap-slider.js - WARNING: $.fn.slider namespace is already bound. Use the $.fn.bootstrapSlider namespace instead."), (h = c)) : (a.bridget(b, d), (h = b)),
                    a.bridget(c, d),
                    a(function () {
