            ...
            a.find(".added-event").each(function (b) {
                ...
                a.find('.this-month[data-date="' + c(this).attr("data-date") + '"]')
                    ...
                    .append(
                        g("div", "event-single")
                            .attr("data-id", b)
                            .append(g("a", "").attr("href", c(this).attr("data-link")).attr("target", "blank").text(c(this).attr("data-title")))
                    );
            });
            M();
        ...
        a.append(
            ...
            g("div", "jalendar-container").append(
                g("div", "jalendar-pages")
                    .append(
                        g("div", "header").append(g("h1"),g("a", "prv-m").append(g("i", "fa fa-angle-left")), g("a", "nxt-m").append(g("i", "fa fa-angle-right")), g("div", "day-names")),
                        g("div", "days"),
                        g("div", "add-event").append(g("div", "events").append(g("h3", "").html("<span></span> " + e[b.lang]), g("div", "events-list")), g("div", "close-button").text(k[b.lang]))
                    )
                    .attr(
                        "style",
                        "background-color:" +
