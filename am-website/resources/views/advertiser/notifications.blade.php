                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card p-3 mb-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap ">
                                <div class="d-flex align-items-start mr-2">
                                    <img src="{{ frontAssets('advertiser/images/accepted-icon.png') }}"
                                        class="img-fluid">
                                    <div class="ml-3">
                        ...
                        <div class="card p-3 mb-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap ">
                                <div class="d-flex align-items-start mr-2">
                                    <img src="{{ frontAssets('advertiser/images/rejected-icon.png') }}"
                                        class="img-fluid">
                                    <div class="ml-3">
                        ...
                        <div class="card p-3 mb-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap ">
                                <div class="d-flex align-items-start mr-2">
                                    <img src="{{ frontAssets('advertiser/images/accepted2-icon.png') }}"
                                        class="img-fluid">
                                    <div class="ml-3">
                        ...
                        <div class="card p-3 mb-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap ">
                                <div class="d-flex align-items-start mr-2">
                                    <img src="{{ frontAssets('advertiser/images/rejected2-icon.png') }}"
                                        class="img-fluid">
                                    <div class="ml-3">
                                        <h5 class="font-16 mb-0 d-flex align-items-center flex-wrap">Offer Rejected</h5>
                                        <p class="mb-0">Mark henry accepted offer made by you.</p>
