            ...
            <div class="container">
                ...
                <nav aria-label="breadcrumb " class="breadcrumb-wrapper  mb-0 mr-2 ">
                    <ol class="breadcrumb mb-0 p-0 bg-white">
                        <li class="breadcrumb-item "><a href="{{ route('adv.home') }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group date position-relative" data-provide="datepicker">
                                                    ...
                                                    <div class="input-group-addon ">
                                                        <img
                                                            src="{{ frontAssets('advertiser/images/calendar-icon.png') }}images/calendar-icon.png">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="img-group d-inline-flex">
                                    <div class="avatar-upload mr-3 d-inline-block">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="background-image: url({{ frontAssets('advertiser/images/img-upload.png') }}images/img-upload.png);">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="position-relative d-inline-block ">
                                        <a href="#" class="mr-2 position-relative d-inline-block">
                                            <img src="{{ frontAssets('advertiser/images/a1.png') }}images/a1.png"
                                                class="img-fluid">
                                            <p class="mb-0 clear-img"><img
                                                    src="{{ frontAssets('advertiser/images/close.png') }}"></p>
                                        </a>
                                        <a href="#" class="mr-2 position-relative d-inline-block">
                                            <img src="{{ frontAssets('advertiser/images/a2.png') }}" class="img-fluid">
                                            <p class="mb-0 clear-img"><img
                                                    src="{{ frontAssets('advertiser/images/close.png') }}"></p>
                                        </a>
                                        <a href="#" class="mr-2 position-relative d-inline-block">
                                            <img src="{{ frontAssets('advertiser/images/a3.png') }}" class="img-fluid">
                                            <p class="mb-0 clear-img"><img
                                                    src="{{ frontAssets('advertiser/images/close.png') }}"></p>
                                        </a>
                                    </div>
                                    ...
                                    <div class="btn-group btn-group-toggle select-ad" data-toggle="buttons">
                                        <label class="btn active p-0 mr-3">
                                            <input type="radio" name="options" id="option1" checked> <img
                                                src="{{ frontAssets('advertiser/images/s1.png') }}">
                                        </label>
                                        <label class="btn p-0 mr-3">
                                            <input type="radio" name="options" id="option2"> <img
                                                src="{{ frontAssets('advertiser/images/s2.png') }}">
                                        </label>
                                        <label class="btn p-0 mr-3">
                                            <input type="radio" name="options" id="option3"> <img
                                                src="{{ frontAssets('advertiser/images/s3.png') }}">
                                        </label>
                                        <label class="btn p-0 mr-3">
                                            <input type="radio" name="options" id="option4"> <img
                                                src="{{ frontAssets('advertiser/images/s4.png') }}">
                                        </label>
                                    </div>
                                </div>
                            </div>
