                    ...
                    <div class="col-md-4 col-xl-5">
                        ...
                        <form action="" method="post" id="adsignupform">
                            ...
                            <div class="form-group relative">
                                ...
                                <input class="form-control" type="text" placeholder="{{trans('labels.v_name')}}" name="name" required>
                            </div>
                            <div class="form-group relative">
                                <i class="icon mail-icon"></i>
                                <input class="form-control" type="text" placeholder="{{trans('labels.v_email')}}" name="email" required>
                            </div>
                            <div class="form-group relative">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <select data-placeholder="Choose one thing" data-allow-clear="1" name="countrycode">
                                            <option>+966</option>
                                            <option>+1</option>
                                            <option>+2</option>
                                            <option>+3</option>
                                    ...
                                    <input class="form-control pl-3" type="text" placeholder="{{trans('labels.v_number')}}" name="number" required data-parsley-errors-container="#err-number">
                                </div>
                           ...
                           <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <div class="form-group relative" id="show_hide_password_1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control pl-2 border-left-0" type="password"
                                        placeholder="{{trans('labels.v_password')}}" name="pass" required
                                        data-parsley-errors-container="#err-advpassword">
                                </div>
                            ...
                            <div class="form-group relative" id="show_hide_password_2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control pl-2 border-left-0" type="password"
                                        placeholder="{{trans('labels.v_confirm_password')}}" name="pass_confirmation" required
                            ...
                            <div class="form-group pt-3">
                                <button type="submit" class="btn btn-purple rounded-pill btn-block" onclick="advSignup()">Sign up</button>
                                {{-- <a href="{{route('adv.otp-verify')}}" class="btn btn-purple rounded-pill btn-block">Sign up</a> --}}
                            </div>
                            <div class="form-group text-right">
                                <p class="text-center pt-3">Already have an account? <a href="{{route('adv.login')}}" class="link">Login
                                        here</a></p>
                            </div>
                        </form>
