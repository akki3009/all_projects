                            ...
                            <div class="d-flex align-items-center justify-content-between p-3">
                                <div>
                                    <div class="text-center d-flex align-items-start ">
                                        <span class="mx-2">
                                            <img src="{{ frontAssets('advertiser/images/facebook-icon.png') }}mages/facebook-icon.png"
                                                class="img-fluid">
                                        </span>
                                        <span class="mx-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="attachment-wrapper">
                                            <a href="#"><img src="{{ frontAssets('advertiser/images/a1.png') }}"
                                                    class="img-fluid mr-2 mb-2"></a>
                                            <a href="#"><img src="{{ frontAssets('advertiser/images/a2.png') }}"
                                                    class="img-fluid mr-2 mb-2"></a>
                                            <a href="#"><img src="{{ frontAssets('advertiser/images/a3.png') }}"
                                                    class="img-fluid mr-2 mb-2"></a>
                                            <a href="#"><img src="{{ frontAssets('advertiser/images/a1.png') }}"
                                                    class="img-fluid mr-2 mb-2"></a>
                                            <a href="#"><img src="{{ frontAssets('advertiser/images/a2.png') }}"
