...
@section('content')
    <main>
        <div class="breadcrumb  p-0 mb-4 bg-white">
            <div class="container">
                <h4 class="mb-0">Invite Advertisers</h4>
                <nav aria-label="breadcrumb " class="breadcrumb-wrapper  mb-0 mr-2 ">
                    <ol class="breadcrumb mb-0 p-0 bg-white">
                        <li class="breadcrumb-item "><a href="{{route('adv.home')}}" class="text-yellow text-decoration-none">My
                                Ads</a></li>
                        <li class="breadcrumb-item "><a href="{{route('adv.home')}}"
                                class="text-yellow text-decoration-none">Standing Requests</a></li>
                        <li class="breadcrumb-item "><a href="{{route('adv.home')}}"
                                class="text-yellow text-decoration-none">Invites</a></li>
                        <li class="breadcrumb-item  active" aria-current="page">Invite Advertisers</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-4">
                    <div class="d-flex  align-items-center justify-content-between">
                        <div class="form-group relative mb-4 flex-auto mr-3">
                            <img src="{{ frontAssets('advertiser/images/search-icon.png') }}" class="search-icon-input img-fluid" width="18px">
                            <input class="form-control form-control-lg border-radius-30 pl-5 search-input" type="text"
                                placeholder="Search by name, city or category" name="email">
                        </div>
                        <a href="#" class="btn btn-primary px-4 mb-4">DONE</a>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="p-3">
                                        <div class="d-flex align-items-start ">
                                            ...
                                            <div class="mx-2 flex-auto">
                                                ...
                                                <p class="font-12 mb-0"><img src="{{ frontAssets('advertiser/images/location-icon.png') }}"
                                                        class="mr-1">Riyadh</p>
                                            </div>
