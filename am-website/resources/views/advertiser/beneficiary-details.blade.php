...
@section('content')
    <main>
        <div class="breadcrumb  p-0 mb-4 bg-white">
            <div class="container">
                <h4 class="mb-0">Beneficiary Details</h4>
                <nav aria-label="breadcrumb " class="breadcrumb-wrapper  mb-0 mr-2 ">
                    <ol class="breadcrumb mb-0 p-0 bg-white">
                        <li class="breadcrumb-item "><a href="{{route('adv.browse')}}" class="text-yellow text-decoration-none">Browse
                                Ads</a></li>
                        <li class="breadcrumb-item "><a href="{{route('adv.view-details')}}"
                                class="text-yellow text-decoration-none">Browse Ads</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="advertise-wrapper">
                                    <img class="img-fluid rounded-circle" src="{{ frontAssets('advertiser/images/profile.png') }}" width="120">
                                    <p class="text-danger font-16 medium mt-3">Leonard Page</p>
                                    ...
                                    <div class="advertise-info">
                                        ...
                                        <div class="form-group mb-4">
                                            <a href="#"
                                                ...
                                                favorites</a>
                                            <!-- <a href="#" class=" btn btn-outline-primary medium px-4  mr-3 mt-4 border-radius-30" >INVITE</a>
                       <a href="#" class=" btn btn-outline-primary medium px-4  mr-3 mt-4 border-radius-30" >CHAT</a> -->
                                        </div>
