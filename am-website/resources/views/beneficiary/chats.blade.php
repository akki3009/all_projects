    ...
    <main>
                    ...
                    <div class="col-lg-4 ">
                        <div class="message-contact-wrapper border-right border-top pt-3">
                            <div class="contact-search">
                                <img src="{{ frontAssets('beneficiary/images/search-icon.png') }}" class="contact-search-icon" width="20">
                            ...
                            <div class="contact-body border-top mt-3">
                                <div class="contact-info">
                                    <div class="contact-image">
                                        <a href="#"><img src="{{ frontAssets('beneficiary/images/chat-3.png') }}" width="50"></a>
                                    </div>
                                ...
                                <div class="contact-info active  standing-active">
                                    <div class="contact-image">
                                        <a href="#"><img src="{{ frontAssets('beneficiary/images/chat-1.png') }}" width="50"></a>
                                    </div>
                                    <a href="#" class="contact-chat-wrapper">
                                        <div>
                                            <div class="contact-chat-detail">
                                ...
                                <div class="contact-info progress-active">
                                    <div class="contact-image">
                                        <a href="#">
                                            <img src="{{ frontAssets('beneficiary/images/chat-2.png') }}" width="50">
       ...
       -->
                                ...
                                <div class="contact-info completed-active">
                                    <div class="contact-image">
                                        <a href="#">
                                            <img src="{{ frontAssets('beneficiary/images/chat-1.png') }}" width="50">
                                ...
                                <div class="contact-info saved-active">
                                    <div class="contact-image">
                                        <a href="#">
                                            <img src="{{ frontAssets('beneficiary/images/chat-3.png') }}" width="50">
                            ...
                            <div class="chat-box-wrapper">
                                <div class="box-header p-2 border-bottom d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-start ">
                                        <img src="{{ frontAssets('beneficiary/images/user1.png') }}" class="img-fluid rounded-circle progress-circle"
                                            width="50px">
                                ...
                                <div class="d-flex align-items-cener justify-content-between border-bottom p-3 flex-wrap">
                                    <div class="d-flex align-items-center ">
                                        <img src="{{ frontAssets('beneficiary/images/s1.png') }}" class="img-fluid " width="80px">
                                        <div class="mx-2 flex-auto">
                                ...
                                <div class="box-footer border-top border-bottom py-3">
                                    <form action="#" method="post" class="d-flex align-items-center">
                                        <a class=" btn-flat px-3"> <img class="attach" src="{{ frontAssets('beneficiary/images/paperclip.png') }}"></a>
                                        ...
                                        <a class=" btn-flat"> <img class="send-msg " src="{{ frontAssets('beneficiary/images/icon-send.png') }}"
