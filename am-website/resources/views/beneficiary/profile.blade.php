                    ...
                    <div class="col-md-4 col-xl-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group relative">
                                ...
                                <input class="form-control" type="text" placeholder="Full Name" name="v_name" value="">
                            </div>
                            <div class="form-group relative">
                            ...
                            <div class="form-group relative" id="show_hide_password_1">
                                <a href="#"><img src="{{ frontAssets('beneficiary/images/eye.svg') }}" width="15px" /></a>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group pt-3">
                                <a href="{{ route('otp-verify') }}" class="btn btn-purple rounded-pill btn-block">Sign
                                    up</a>
                            </div>
...
@push('js')
    ...
    <script>
        ...
        var profile_route = "{{ route('front.userUpdate') }}";
    </script>
@endpush
@push('jsfun')
