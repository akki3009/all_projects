            ...
            <div class="container-xl">
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <figure class="text-center"><img src="{{ frontAssets('beneficiary/images/qoute.svg') }}" alt=""></figure>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <figure class="wow animate__animated animate__fadeInLeft text-center mt-5 p-4"><img
                                src="{{ frontAssets('beneficiary/images/img.png') }}" class="img-fluid rounded-circle" alt=""></figure>
                    </div>
                    <div class="col-md-6 pt-5">
                        <div class="card wow animate__animated animate__fadeInRight mt-5">
                            <figure><img src="{{ frontAssets('beneficiary/images/mission.svg') }}" alt=""></figure>
                            <h3>Our Mission</h3>
                ...
                <div class="row">
                    <div class="col-md-6 pt-5">
                        <div class="card wow animate__animated animate__fadeInLeft mt-5">
                            <figure><img src="{{ frontAssets('beneficiary/images/vision.svg') }}" alt=""></figure>
                            <h3>Our Vision</h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                                been the industry's standard. Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. Lorem Ipsum has been the industry's standard. Lorem Ipsum is simply
