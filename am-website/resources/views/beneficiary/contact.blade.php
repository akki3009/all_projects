                    ...
                    <div class="contact-inf">
                        <div class="card ">
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <img src="{{ frontAssets('beneficiary/images/map-pin.png') }}" class="mr-3 mt-1">
                                <p class="text-black font-16 mb-0 light">Lorem Ipsum is simply dummy text, dummy text.</p>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                                <img src="{{ frontAssets('beneficiary/images/phone.png') }}" class="mr-3">
                                <p class="text-black font-16 mb-0 light">+966 000 000 000</p>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                                <img src="{{ frontAssets('beneficiary/images/mail.png') }}" class="mr-3">
                        ...
                        <div class="form-group">
                            <a href="#"
                                class="btn btn-outline-success border-radius-30 d-flex align-items-center justify-content-center w-100"><img
                                    src="{{ frontAssets('beneficiary/images/whatsapp.png') }}" class="mr-2"> +966
                                343-487-4987</a>
                        </div>
                    </div>
                </div>
