                    ...
                    <div class="col-md-4 col-xl-5">
                        ...
                        <form action="">
                            <div class="form-group relative">
                                ...
                                <input class="form-control form-control-lg" type="text" placeholder="{{trans('labels.otp')}}" name="otp">
                            </div>
                    ...
                    <form class="">
                        <div class="form-group relative py-4">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control pl-3" type="text" placeholder="{{ trans('labels.v_number') }}"
