                ...
                <nav aria-label="breadcrumb " class="breadcrumb-wrapper  mb-0 mr-2 ">
                    <ol class="breadcrumb mb-0 p-0 bg-white">
                        <li class="breadcrumb-item ">
                            <a href="{{ route('my-ads') }}" class="text-yellow text-decoration-none">My
                                Ads</a>
                        </li>
                        <li class="breadcrumb-item ">
                            <a href="#" class="text-yellow text-decoration-none">Standing Requests</a>
                        </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="{{ route('my-ads') }}" class="btn btn-primary px-4 submit-contract-btn d-none">SUBMIT</a>
                    </div>
                </div>
            </div>
            <!-- /.MultiStep Form -->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form action="">
                                            ...
                                            <div class="text-center">
                                                <img src="{{ frontAssets('beneficiary/images/sign.png') }}"
                                                    class="img-fluid">
                                            </div>
                                            <div class="form-group text-center">
                                                <a href="#" data-dismiss="modal"
                            ...
                            <div class="col-12 mb-3">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <form action="">
                                            <div class="text-center">
                                                <img src="{{ frontAssets('beneficiary/images/delete-ad.png') }}"
