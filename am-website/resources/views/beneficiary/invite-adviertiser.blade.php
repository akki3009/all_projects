            ...
            <div class="container">
                ...
                <nav aria-label="breadcrumb " class="breadcrumb-wrapper  mb-0 mr-2 ">
                    <ol class="breadcrumb mb-0 p-0 bg-white">
                        <li class="breadcrumb-item "><a href="{{route('home')}}" class="text-yellow text-decoration-none">My
                                Ads</a></li>
                ...
                <div class="col-md-8 mb-4">
                    <div class="d-flex  align-items-center justify-content-between">
                        <div class="form-group relative mb-4 flex-auto mr-3">
                            <img src="{{ frontAssets('beneficiary/images/search-icon.png') }}" class="search-icon-input img-fluid" width="18px">
                                    ...
                                    <div class="p-3">
                                        <div class="d-flex align-items-start ">
                                            ...
                                            <div class="mx-2 flex-auto">
                                                ...
                                                <p class="font-12 mb-0"><img src="{{ frontAssets('beneficiary/images/location-icon.png') }}"
                                                        class="mr-1">Riyadh</p>
                                            </div>
