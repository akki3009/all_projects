...
@section('content')
    <div class="hero-banner d-flex align-items-center" id="home">
        <div class="hero-content">
            ...
            <span class="element"><img src="{{ frontAssets('beneficiary/images/banner_shape.svg') }}" width="100%"></span>
        </div>
    </div>
    <!--/hero-banner-->
    <!--main-->
                ...
                <div class="row box">
                    <div class="col-md-4">
                        <div class="card wow animate__animated animate__fadeInUp">
                            <img src="{{ frontAssets('beneficiary/images/flexible.svg') }}" alt="" />
                    ...
                    <div class="col-md-4">
                        <div class="card wow animate__animated animate__fadeInUp">
                            <img src="{{ frontAssets('beneficiary/images/deals.svg') }}" alt="" />
                    ...
                    <div class="col-md-4">
                        <div class="card wow animate__animated animate__fadeInUp">
                            <img src="{{ frontAssets('beneficiary/images/payments.svg') }}" alt="" />
        ...
        <section class="howitworks overflow-hidden" id="how-it-works">
            <div class="container-xl">
                ...
                <div class="steplists">
                    <div class="row right">
                        <div class="col-md-6">
                            <figure class="wow animate__animated animate__fadeInLeft"><img src="{{ frontAssets('beneficiary/images/img1@2x.png') }}"
                        ...
                        <div class="col-md-6 divider step1">
                            <div class="card wow animate__animated animate__fadeInRight">
                                <div><img src="{{ frontAssets('beneficiary/images/file.svg') }}" alt=""><span class="purple">STEP 1</span></div>
                    ...
                    <div class="row left">
                        <div class="col-md-6 divider step2">
                            <div class="card wow animate__animated animate__fadeInLeft">
                                <div><img src="{{ frontAssets('beneficiary/images/offer.svg') }}" alt=""><span class="magenta">STEP 2</span></div>
                        ...
                        <div class="col-md-6">
                            <figure class="wow animate__animated animate__fadeInRight"><img src="{{ frontAssets('beneficiary/images/img2@2x.png') }}"
                                    class="img-fluid rounded-circle" alt="" /></figure>
                        </div>
                    </div>
                    <div class="row right">
                        <div class="col-md-6">
                            <figure class="wow animate__animated animate__fadeInLeft"><img src="{{ frontAssets('beneficiary/images/img3@2x.png') }}"
                                    class="img-fluid rounded-circle" alt="" /></figure>
                        </div>
                        <div class="col-md-6 divider step3">
                            <div class="card wow animate__animated animate__fadeInRight">
                                <div><img src="{{ frontAssets('beneficiary/images/negotiate.svg') }}" alt=""><span class="orange">STEP 3</span></div>
                    ...
                    <div class="row left">
                        <div class="col-md-6 divider step4">
                            <div class="card wow animate__animated animate__fadeInLeft" style="margin-bottom: 50px;">
                                <div><img src="{{ frontAssets('beneficiary/images/close_deal.svg') }}" alt=""><span class="yellow">STEP 4</span></div>
                                <h3>Close A Deal</h3>
                                <p>Fill few details to create and post advertisement. Lorem Ipsum is simply dummy text of
                                    the printing and typesetting industry. Lorem Ipsum has been the industry's standard.</p>
                            </div>
                        ...
                        <div class="col-md-6">
                            <figure class="wow animate__animated animate__fadeInRight"><img src="{{ frontAssets('beneficiary/images/img4@2x.png') }}"
                                    class="img-fluid rounded-circle" alt="" /></figure>
                        </div>
                    </div>
                </div>
